        ...
        <div className="grid grid-cols-1 lg:grid-cols-8 gap-8">
          ...
          <div className="flex flex-col justify-between lg:col-span-4 space-y-6">
            ...
            <div className="space-y-3">
              {/* Add to Cart Button */}
              <button className="w-full py-3 bg-sky-600 text-white font-bold rounded-full shadow-lg shadow-sky-800/50 cursor-pointer hover:bg-sky-700 transition duration-300 flex items-center justify-center gap-2">
                <ShoppingCart className="w-5 h-5" />
                <span>Add to Cart</span>
              </button>

              {/* Keep Shopping Button (Outline Style) */}
              <Link 
                to={'/'} 
